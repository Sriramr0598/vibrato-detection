...
# Selecting the note to be anaylzed
...
for file in files:
    ...
    # 3. The gathered required per-frame data, we can feed it to the contour
    ...
    # Calculate the percentage of peaks in the pitch countor's derivative
